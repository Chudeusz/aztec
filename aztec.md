...
## Jak użyć?
**1. Do debugowania Api Azteca najlepiej użyć Postmana, jest dostępny jako [aplikacja](https://www.postman.com/) lub [wtyczka do chrome](https://chrome.google.com/webstore/detail/postman/fhbjgbiflinjbdggehcddcbncdddomop?hl=pl)**

**2. W adres zapytania wpisujemy**

```code
Przykładowo http://10.137.203.3:9293/api/car/aztec dla Ghost3
```
**trzeba być na odpowiednim VPN**

**3. Dodajemy nagłówek w Headers**
```code
 W kolumnie KEY: Content-Type: a w kolumnie VALUE: application/json
```
**4. Wybieramy metode POST**

**5. W treści body zaznaczamy raw i wpisujemy JSON'a:**

```json
{
  "aztec": "zeskanowany kod aztec"
}
```
![Odpowiedź](https://prnt.sc/rpa154)
